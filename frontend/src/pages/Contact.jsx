...
// const RECIPIENT = "mohamednapil@gmail.com";
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        input:focus, textarea:focus { border-color: #e63946 !important; }
        @media (max-width: 768px) {
          .contact-card { padding: 0.8rem !important; }
        }
      `}</style>
      ...
      <div style={{ display: "flex", gap: "2rem", width: "100%", maxWidth: 1200, flexWrap: "wrap", alignItems: "flex-start", justifyContent: "center" }}>
        ...
        <div style={{ flex: "1 1 340px", minWidth: 280 }}>
          ...
          <div style={{ background: "#141414", border: "1px solid #222", borderRadius: 14, padding: "1rem" }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 24, color: "#e63946", textAlign: "center", letterSpacing: 3, margin: "0 0 1.5rem" }}>
            INQUIRY TERMINAL
          </h2>
          ...
          {error && (
            <div style={{ color: "#e63946", fontSize: 12, fontFamily: "'Cairo',sans-serif", marginBottom: 10, textAlign: "center" }}>
              {error}
            </div>
          )}
