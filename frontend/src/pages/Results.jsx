...
//     if (!el) return;
//     const wheelLock = { v: false };
//     const onWheel = (e) => {
//       e.preventDefault();
//       if (wheelLock.v) return;
//       wheelLock.v = true;
//       const d = Math.abs(e.deltaX) > Math.abs(e.deltaY) ? e.deltaX : e.deltaY;
//       go(d > 0 ? 1 : -1);
//       setTimeout(() => { wheelLock.v = false; }, 550);
//     };
...
//     setGrabbing(true);
//   };
//   const onMouseMove = (e) => { if (!isDragRef.current) return; };
//   const onMouseUp = (e) => {
...
//           <div
//             key={i}
//             onClick={() => { if (!lockRef.current) { lockRef.current = true; setIdx(i); setTimeout(() => { lockRef.current = false; }, 450); } }}
//             style={{
//               width: i === idx ? 24 : 8,
//               height: 8,
//               borderRadius: 4,
