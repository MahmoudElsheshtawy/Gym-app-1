...
const events = [
  { date: "2021", color: "#FFC107", icon: "🏋️", title: "بدأ رحلتي مع الجيم", desc: "أول يوم في الصالة وقرار التغيير" },
  { date: "90 يوم", color: "#FFC107", icon: "💪", title: "أول 90 يوم من التحول", desc: "تغيير ملحوظ في الجسم والقوة" },
  { date: "الآن", color: "#FFC107", icon: "🏆", title: "أكثر من 300 عميل", desc: "نتائج حقيقية في مصر والخليج" },
];
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-5 hover:border-white/20 transition">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-500 to-yellow-700 flex items-center justify-center font-bold">
          {post.avatar}
        </div>
      ...
      {post.cta && (
        <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-700/20 border border-yellow-500/20 rounded-xl p-4 text-center mb-4">
          ...
          <a href="https://wa.me/201558864839" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
            <button className="bg-yellow-500 hover:bg-yellow-600 transition px-5 py-2 rounded-full text-sm font-bold text-black">
              {post.cta.btn}
            </button>
          </a>
        </div>
      ...
      <div className="flex items-center justify-between text-white/50 text-xs border-t border-white/10 pt-3">
        <button onClick={() => setLiked(!liked)} className="flex items-center gap-1 hover:text-yellow-400">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end gap-4 -mt-12 mb-6">
          ...
          <div className="flex gap-2">
            <button className="bg-yellow-500 px-5 py-2 rounded-full text-sm font-bold text-black hover:bg-yellow-600">
              Follow
            </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
              <h3 className="text-yellow-500 font-bold mb-2">About</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
              <h3 className="text-yellow-500 font-bold mb-3">Photos</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
              <h3 className="text-yellow-500 font-bold mb-3">Timeline</h3>
              <div className="space-y-3">
                {events.map((ev, i) => (
                  <div key={i} className="text-xs border-l border-white/10 pl-3">
                    <div className="text-yellow-400 font-bold">{ev.date}</div>
